    ...
    <div class="adcontainer">
        ...
        <div id="blog" class="blog">
            <form action="#">
                ...
                <div class="form-group">
                    <label>Content</label>
                    <textarea class="form-control" name="blogcontent" id="" cols="25" rows="10" placeholder="Enter blog content"></textarea>
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <textarea class="form-control" name="blogcontent" id="" cols="5" rows="5" placeholder="Enter description"></textarea>
                </div>
                <div class="form-group">
                    <label>Photo</label> <br />
